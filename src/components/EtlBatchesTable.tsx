                      ...
                      <td className="py-3.5 px-4 text-center" onClick={(e) => e.stopPropagation()}>
                        ...
                        >
                          ...
                          <button
                            ...
                            className="p-1.5 text-gray-500 hover:text-gray-900 hover:bg-gray-100 group-hover:bg-gray-100 group-hover:text-gray-900 rounded-md border border-gray-200 transition-colors cursor-pointer shadow-2xs focus:outline-hidden"
                            title="Actions Menu"
                          >
                            <MoreHorizontal className="w-4 h-4" />
                          </button>

                          {/* Hover Display Action Menu */}
                          <div 
                            className={`absolute right-0 top-full mt-1 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-1.5 z-40 transition-all duration-150 transform origin-top-right ${
                              openMenuId === batch.id 
                                ...
                                : 'opacity-0 scale-95 pointer-events-none invisible group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto group-hover:visible'
                            }`}
                          >
